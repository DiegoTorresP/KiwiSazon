...
const sendEmailPass = (recipient, token) => {
    const mailOptions = {
      from: 'libritomxdev@gmail.com',
      to: recipient,
      subject: `Restablecer tu contraceña`,
      html:  ` 
                                                      ...
                                                      <table border="0" cellpadding="0" cellspacing="0"
                                                          ...
                                                          <tr>
                                                              <td class="pad"
                                                                  ...
                                                                  <div align="center" class="alignment"
                                                                      style="line-height:10px"><img alt="I'm an image"
                                                                          class="big" src="https://cdn-icons-png.flaticon.com/512/6195/6195700.png"
                                                                  ...
                                                                  <div style="font-family: sans-serif">
                                                                      <div class=""
                                                                          ...
                                                                          <p
                                                                              ...
                                                                              <span
                                                                                  style="font-size:30px;color:#2b303a;"><strong>Restablece tu contraseña</strong></span>
                                                                          </p>
                                                                      </div>
                                                                  </div>
                                                              </td>
                                                                  ...
                                                                  <div style="font-family: sans-serif">
                                                                      <div class=""
                                                                          ...
                                                                          <p
                                                                              ...
                                                                              <span
                                                                                  style="color:#808389;font-size:15px;">Hemos recibido una solicitud para restablecer su contraseña.</span><br>
                                                                                  <span
                                                                                  style="color:#808389;font-size:15px;">Si no has realizado esta solicitud, simplemente ignora este correo electrónico.</span>
                                                                                  <span
                                                                                  style="color:#808389;font-size:15px;">Se te proporcionará un codigo para poder restablecer tu contraseña</span>
                                                                              </p>
                                                                      </div>
                                                                  </div>
                                                              </td>
                                                                      ...
                                                                      <a href="{{href_value}}"
                                                                          ...
                                                                          <span
                                                                              style="padding-left:30px;padding-right:30px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
                                                                                  style="margin: 0; word-break: break-word; line-height: 32px;"><strong>${token}</strong></span></span>
                                                                      </a>
